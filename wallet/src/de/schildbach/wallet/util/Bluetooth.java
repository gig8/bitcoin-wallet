...
public class Bluetooth {
    ...
    public static final String BIP70_PAYMENT_PROTOCOL_NAME = "MotaCoin BIP70 payment protocol";
    ...
    public static final String CLASSIC_PAYMENT_PROTOCOL_NAME = "MotaCoin classic payment protocol (deprecated)";
